        ...
        <div class="px-10 2xl:px-0">
            ...
            <div class="my-6 gap-8 sm:flex sm:items-start md:my-8">
                ...
                <div class="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="flex items-center gap-2">
                            <p class="w-2 shrink-0 text-start text-sm font-medium leading-none text-gray-900 dark:text-white">{{ $i }}</p>
                        ...
                        <div class="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                            <div class="h-1.5 rounded-full bg-yellow-300"
                                    style="width: {{ $stats['totalComments'] ? ($stats['ratings'][$i] / $stats['totalComments']) * 100 : 0 }}%">
                            </div>
                        </div>
                        <a href="#"
                                class="w-8 shrink-0 text-right text-sm font-medium leading-none text-gray-700 hover:underline dark:text-gray-500 sm:w-auto sm:text-left">{{ $stats['ratings'][$i] ?? 0 }}
