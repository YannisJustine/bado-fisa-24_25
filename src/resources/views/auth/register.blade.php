...
@section('content')
    <div class="py-20 flex flex-col px-6 py-6 lg:px-8 bg-center bg-no-repeat  bg-cover text-white">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-shadow-sm shadow-black">Inscription d'un candidat
            </h2>
        </div>

        <div class="mt-10 sm:mx-auto sm:w-full bg-gray-700 bg-opacity-20 sm:max-w-lg sm:p-5">
            <form class="space-y-6" action="#" method="POST">
                <div class="relative z-0 w-full mb-5 group">
                    <input type="last_name" name="floating_last_name" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div class="relative">
                    ...
                    <input datepicker datepicker-orientation="bottom" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Date de naissance">
                </div>

                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-ensiie-main-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-ensiie-main-500 ">Sign
                        in</button>
                </div>
            </form>
        </div>
